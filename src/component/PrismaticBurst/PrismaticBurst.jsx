...
const PrismaticBurst = ({
  ...
  return (
  <div className="prismatic-burst-container" ref={containerRef} style={{}}>

    <div id="heading_container">
      <h1 id="hello_heading">
        He<span style={{color:'#4d3dff',fontFamily:'astral'}}>ll</span>o
      </h1>
    ...
    <h5 id='longLive'>This web page live longer</h5>
  </div>
);
};
